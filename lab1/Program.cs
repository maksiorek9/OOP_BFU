...
internal class Program
{
    public static void Main(string[] args)
    {
        ...
        var ang1 = new Angel(40);
        var ang2 = new Angel(0.5f,"+");
        var ang3 = new Angel(170);
        var ang4 = new Angel(0.9f,"+");

        // Console.WriteLine(ang1.comparison(ang1, ang2,"[]",3));
        Console.WriteLine(ang2>ang1);
        Console.WriteLine($"{ float.TryParse(ang1.ToString())} {Convert.ToInt32(ang1.ToString()).GetType()} /n {ang1} {ang1.GetType()} /n" +
                           $"{Convert.ToString(ang1)} {ang1.ToString().GetType()}");
        Console.WriteLine(ang1.ToString());
